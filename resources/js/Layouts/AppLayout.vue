                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('settings.factories.index')"
                                ...
                                <div class="inline-flex items-center">
                                    <menu-dropdown width="48" :class="classessubmenu">
                                        <template #trigger>
                                        ...
                                        <template #content>
                                            ...
                                            <jet-dropdown-link :href="route('inventory.index')">
                                              Inventory
                                            </jet-dropdown-link>
                                ...
                                <div class="inline-flex items-center">
                                    <menu-dropdown width="48" :class="classessubmenu">
                                        ...
                                        <template #content>
                                            <jet-dropdown-link :href="route('accounts.invoices')">
                                                Client
                                            </jet-dropdown-link>
